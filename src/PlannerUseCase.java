...
public final class PlannerUseCase {
    ...
    public static void main(String[] args) {
        ...
        dailyPlanner
                .addTask(new Task("Software HW", "04/24/26", "School", false));
        dailyPlanner.addTask(
                new Task("Foundations HW", "05/04/26", "School", false));
        dailyPlanner
                .addTask(new Task("Moring Shift", "04/21/26", "Work", true));
        dailyPlanner.addTask(new Task("Workout", "04/21/26", "Health", true));
        dailyPlanner.addTask(new Task("Run", "04/21/26", "Health", false));
        ...
        out.println("Incomplete Tasks: " + dailyPlanner.incompleteTasks());
